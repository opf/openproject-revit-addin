...
namespace OpenProject.Shared.Math3D
{
  ...
  public sealed class AxisAlignedBoundingBox : IEquatable<AxisAlignedBoundingBox>
  {
    ...
    /// <summary>
    /// Merges this bounding box with the given one and returns the resulting bounding box, that is included in both
    /// bounding boxes. If there is no intersection between both bounding boxes, an infinite bounding box is returned.
    /// </summary>
